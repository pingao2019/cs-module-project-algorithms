...
#Given a sorted array of distinct non-negative integers, find the smallest missing element in it.Examples

#Input: A = [0, 1, 2, 6, 9, 11, 15] Output: The smallest missing element is 3

#nput: A = [1, 2, 3, 4, 6, 9, 11, 15] Output: The smallest missing element is 0
